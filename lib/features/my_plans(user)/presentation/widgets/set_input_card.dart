...
class SetInputCard extends StatelessWidget {
  ...
  const SetInputCard({
    super.key, required this.currentSet, required this.totalSets,
    required this.weightController, required this.repsController,
    required this.isPaused, required this.isLoading,
    required this.onLogSet, required this.onSkipSet,
  });
                    ...
                    children: [
                      ...
                      Expanded(
                        child: TextField(
                          ...
                          decoration: const InputDecoration(border: InputBorder.none, hintText: "0.0", hintStyle: TextStyle(color: Colors.grey)),
                        ),
                      ),
                    ],
                  ),
