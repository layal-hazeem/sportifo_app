...
class EditProfileRequestModel {
  ...
  Map<String, dynamic> toMap() {
    ...
    add('gender', gender == null ? null : (gender! ? 1 : 0));

    add('height', height);
    add('weight', weight);

    add('shoulders_width', shoulders_width);
    add('chest_perimeter', chest_perimeter);
    add('waist_perimeter', waist_perimeter);
    add('thigh_perimeter', thigh_perimeter);
    add('hip_perimeter', hip_perimeter);
    add('arm_perimeter', arm_perimeter);
