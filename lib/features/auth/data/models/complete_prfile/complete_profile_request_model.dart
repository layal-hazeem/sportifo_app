...
class CompleteProfileRequestModel {
  ...
  CompleteProfileRequestModel copyWith({
    ...
    return CompleteProfileRequestModel(
      ...
      stomach_perimeter: stomach_perimeter ?? this.stomach_perimeter,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'stomach_perimeter': stomach_perimeter,
  ...
  factory CompleteProfileRequestModel.fromMap(Map<String, dynamic> map) {
    return CompleteProfileRequestModel(
      ...
      profile_pic: map['profile_pic'] != null ? map['profile_pic'] as String : null,
      shoulders_width: map['shoulders_width'] != null ? map['shoulders_width'] as double : null,
      chest_perimeter: map['chest_perimeter'] != null ? map['chest_perimeter'] as double : null,
      stomach_perimeter: map['stomach_perimeter'] != null ? map['stomach_perimeter'] as double : null,
      waist_perimeter: map['waist_perimeter'] != null ? map['waist_perimeter'] as double : null,
      thigh_perimeter: map['thigh_perimeter'] != null ? map['thigh_perimeter'] as double : null,
      hip_perimeter: map['hip_perimeter'] != null ? map['hip_perimeter'] as double : null,
      arm_perimeter: map['arm_perimeter'] != null ? map['arm_perimeter'] as double : null,
    );
  }

  String toJson() => json.encode(toMap());

  factory CompleteProfileRequestModel.fromJson(String source) => CompleteProfileRequestModel.fromMap(json.decode(source) as Map<String, dynamic>);

  @override
  String toString() {
    return 'CompleteProfileRequestModel(first_name: $first_name, last_name: $last_name, email: $email, phone: $phone, date_of_birth: $date_of_birth, gender: $gender, height: $height, weight: $weight, update_pic: $update_pic, profile_pic: $profile_pic, shoulders_width: $shoulders_width, chest_perimeter: $chest_perimeter, stomach_perimeter: $stomach_perimeter, waist_perimeter: $waist_perimeter, thigh_perimeter: $thigh_perimeter, hip_perimeter: $hip_perimeter, arm_perimeter: $arm_perimeter)';
  }
  ...
  bool operator ==(covariant CompleteProfileRequestModel other) {
    ...
    return 
      ...
      other.stomach_perimeter == stomach_perimeter &&
